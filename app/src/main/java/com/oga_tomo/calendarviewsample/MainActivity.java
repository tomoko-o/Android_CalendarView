...
public class MainActivity extends ActionBarActivity{
    ...
    public static class PlaceholderFragment extends Fragment
            implements OnDateClickListener, OnNextBackClickListener{
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            calendarView.set(MonthlyCalendar.getToday(MonthlyCalendar.TODAY_YEAR)
                             , MonthlyCalendar.getToday(MonthlyCalendar.TODAY_MONTH), true, true);
